...
export const Home = () => {
    ...
    <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent  leading-right mb-8">Hi, I am Dwi Nurhidayat</h1>
